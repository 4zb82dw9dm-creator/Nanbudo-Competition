...
function MatchManager({ match, nextPassage, onSave }) {
  ...
  function save() {
    ...
    if (isLocked) return;
    if (!randoriScore.winner) return alert("Saisissez un score complet et désignez un vainqueur avant de valider.");
