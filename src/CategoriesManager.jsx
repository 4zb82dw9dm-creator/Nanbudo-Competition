...
function CategoriesManager({ competition, onUpdateCompetition }) {
  ...
  function mergeSelected() {
    ...
    const merged = { id: Date.now(), nom: categoryName.trim() || `Fusion · ${selected.map((category) => category.nom).join(" + ")}`, discipline, competitorIds, statut: "Prête", manual: true };
