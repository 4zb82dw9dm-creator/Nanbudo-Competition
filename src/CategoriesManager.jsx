...
function CategoriesManager({ competition, onUpdateCompetition }) {
  ...
  function updateKataGroup(categoryId, kataGroup) {
    ...
    if (category?.manual !== true && ageRule && kataGroup !== ageRule.kataGroup) {
      return alert(`${ageRule.ageGroup || "Cette catégorie d’âge"} : ${ageRule.kataGroup} est obligatoire. Une dérogation reste possible après fusion manuelle.`);
    }
