...
import { KATA_GROUP_OPTIONS } from "./constants/katas";
...
function CategoriesManager({ competition, onUpdateCompetition }) {
  ...
  function mergeSelected() {
    ...
    const kataGroup = competitionRulesEngine.isKataDiscipline(discipline) ? (selected.find((category) => category.kataGroup)?.kataGroup || KATA_GROUP_OPTIONS[0]) : "";
